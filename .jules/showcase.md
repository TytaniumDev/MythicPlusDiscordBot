...
- **[2025-02-19]** Replaced placeholder hero image with `readme_assets/hero_visual.png` (sourced from visual tests) to improve "Curb Appeal". Updated "Contributing" link to point to `CONTRIBUTING.md` (for humans) instead of `AGENTS.md` (for bots) to reduce confusion.
